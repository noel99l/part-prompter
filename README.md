...
| `/prompter/playlist/[id]` | 不要 | セットリストプロンプター |
| `/how-to-use` | 不要 | 使い方 |
| `/privacy` | 不要 | プライバシーポリシー |
| `/admin` | 必要 | 管理トップ |
| `/admin/songs` | 必要 | パート分け管理（自分の楽曲のみ） |
| `/admin/[songId]` | 必要 | パート分け編集（作成者のみ） |
| `/admin/playlists` | 必要 | セットリスト管理（自分のセットリストのみ） |
| `/admin/playlists/[id]` | 必要 | セットリスト編集 |
