...
const GROUPS = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        sections: [
          { title: 'パート・歌詞の確認', body: '作者・パートメンバー・歌詞分けの内容を閲覧できます。各行の右端にパートの色ドットが表示されます。' },
          { title: '⋯ メニュー', body: '右上の⋯ボタンからコピーや複製メニューを開けます。' },
          { title: '📋 歌詞分けをコピー', body: 'テキスト形式（(A)歌詞...）をクリップボードにコピーできます。' },
        ...
        tabs: [
          {
            ...
            items: [
              ...
              { title: '一覧への公開', body: 'トグルで公開/非公開を切り替えられます。非公開にすると歌詞分け一覧に表示されなくなります。デフォルトは公開です。' },
