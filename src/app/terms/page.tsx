    ...
    <div style={{ background: '#0a0a0a', minHeight: '100vh', color: '#ccc', fontFamily: "'Hiragino Sans', sans-serif", padding: '2rem 1.5rem', boxSizing: 'border-box' }}>
      <div style={{ maxWidth: 680, margin: '0 auto' }}>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={p}>本サービスは、歌詞のパート分け管理およびプロンプター表示機能を提供します。ログインなしで公開されたパート分けの閲覧・プロンプター利用が可能です。Googleアカウントでログインすることで、パート分けの作成・編集・プレイリスト管理が利用できます。</p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p style={p}>ユーザーが登録した楽曲情報・歌詞・パート分けデータの著作権はユーザー本人に帰属します。公開設定にしたコンテンツは、他のユーザーが閲覧・プレイリストへの追加・複製して編集することができます。</p>
